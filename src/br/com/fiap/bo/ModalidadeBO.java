...
public class ModalidadeBO {
	...
	public void cadastrar(Modalidade Modalidade) throws DBException {
		EntityManager em = fabrica.createEntityManager();
		ModalidadeDAO dao = new ModalidadeDAOImpl(em);
		dao.cadastrar(Modalidade);
		dao.salvar();
		em.close();
	}
	
	public void atualizar(Modalidade Modalidade) throws DBException{
		EntityManager em = fabrica.createEntityManager();
		ModalidadeDAO dao = new ModalidadeDAOImpl(em);
	...
	public Modalidade buscar(int codigo){
		EntityManager em = fabrica.createEntityManager();
		ModalidadeDAO dao = new ModalidadeDAOImpl(em);
		Modalidade Modalidade = dao.pesquisar(codigo);
		em.close();
		return Modalidade;
	}
